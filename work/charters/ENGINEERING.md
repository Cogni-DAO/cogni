...
**Rollup**: 2 🟢 / 8 🟡 / 8 🔴 across 18 stages (was 2 🟢 / 9 🟡 / 7 🔴). One yellow-stripe regression: `Flight to candidate-a` regressed 🟡 → 🔴 on hard signal — endpoint exists, agents bypass it 100%.
