...
| 19  | **deploy-infra unconditional** — SSH + Argo wait + compose up on every promotion, even code-only PRs                                                                                                                                                                                       | 🟡 FOLLOW-UP | —     | Gate on `infra/compose/**` changed; code-only promotions skip SSH (~5-8 min saved)                                                                                                                                                                                                                                                                                                                                                                            |
