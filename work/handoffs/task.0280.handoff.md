...
- Validated green end-to-end on candidate-a: bug.0322 regression closed at both API and DB layers, real LLM content on operator + poly, zero cross-contamination. See [PR #922 flight validation comment](https://github.com/Cogni-DAO/cogni/pull/922#issuecomment-4275333351).
...
- **In-progress right now**: GitHub Actions `Promote and Deploy` workflow run [24633902426](https://github.com/Cogni-DAO/cogni/actions/runs/24633902426) dispatched at 16:36Z for `b24922b6` (main HEAD). `b24922b6` **does** include task.0280.
...
- [ ] Monitor [Promote and Deploy run 24633902426](https://github.com/Cogni-DAO/cogni/actions/runs/24633902426) to completion; if it fails, read logs + file a bug.
