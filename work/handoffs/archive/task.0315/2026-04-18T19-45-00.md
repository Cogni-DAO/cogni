...
| ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| [docs/spec/poly-copy-trade-execution.md](../../docs/spec/poly-copy-trade-execution.md)                                              | Phase 1 spec — file layout by layer, invariants, E2E scenarios, deferred pointers.                               |
