---
id: task.0315.handoff.2026-04-17-cp3
type: handoff
...
- **Branch:** `design/poly-copy-trade-pr-b` (PR [#890](https://github.com/Cogni-DAO/cogni/pull/890))
...
- **Use `@privy-io/node/viem#createViemAccount`**, not a hand-rolled shim. Private discovery during CP2 rev 4; replaces the planned `PolymarketOrderSigner` adapter path. [Commit 4e1202124](https://github.com/Cogni-DAO/cogni/commit/4e1202124).
...
| [PR #890](https://github.com/Cogni-DAO/cogni/pull/890)                                               | Phase-1 flight PR — merges to main when a real `order_id` lands                                                       |
