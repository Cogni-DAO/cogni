...
Research spike [spike.0113](spike.0113.dao-gateway-sdk.md) identified a Config-File Gateway as the simplest path to let any AI project become a DAO with crypto billing. Our existing LiteLLM + billing infrastructure already does 90% of what's needed — it just needs multi-tenanting.
