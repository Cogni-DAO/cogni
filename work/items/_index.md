...
| 1 | 30 | 1 | needs_review | bug.0331 | verify-buildsha races with rolling-update endpoint cutover, false-fails on freshly-rolled deployments | CI/CD Pipeline | proj.cicd-services-gitops |
