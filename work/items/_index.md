...
| 0 | 99 | 2 | needs_merge | task.0320 | Per-node flighting substrate — per-env deploy branches + per-node AppSets (candidate-a + preview + production) | CI/CD Pipeline | proj.cicd-services-gitops |
| 0 | 99 | 3 | needs_implement | task.0372 | Per-node matrix cutover across candidate-a / preview / production workflows | CI/CD Pipeline | proj.cicd-services-gitops |
