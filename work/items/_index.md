...
| 0 | 1 | 2 | needs_triage | bug.0306 | GitHub OAuth broken across deployments — single callback app cannot serve multi-node origins | CI/CD Pipeline | proj.cicd-services-gitops |
