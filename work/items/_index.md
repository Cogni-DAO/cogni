...
| 0 | 99 | 2 | needs_closeout | task.0320 | Per-node candidate flighting (partial promotion + per-node leases) | CI/CD Pipeline | proj.cicd-services-gitops |
| 0 | 99 | 2 | needs_implement | task.0371 | candidate-flight matrix cutover — Turbo-affected fan-out + delete whole-slot lease | CI/CD Pipeline | proj.cicd-services-gitops |
