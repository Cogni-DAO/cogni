...
| 1 | 5 | 4 | needs_implement | bug.0331 | Overlay config drift — deploy branches are a mutable state store with no single truth source | CI/CD Pipeline | proj.cicd-services-gitops |
