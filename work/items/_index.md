...
| 0 | 1 | 1 | needs_triage | bug.0224 | Codex binary MODULE_NOT_FOUND in Docker — standalone bundles pruned @openai/codex, bypasses global install | BYO-AI: Bring Your Own LLM Provider | proj.byo-ai |
