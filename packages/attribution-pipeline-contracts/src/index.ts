 ...
 * - CONTRACTS_NO_IMPLEMENTATIONS: this package defines interfaces and dispatch functions only. All concrete implementations live in @cogni/attribution-pipeline-plugins.
