...
- **TARGET_POSITION_IS_CONTEXT** — target-wallet position data is read outside the planner and supplied as `RuntimeState.target_position`; it is context for follow-up policy, not a persisted authority in this slice.
