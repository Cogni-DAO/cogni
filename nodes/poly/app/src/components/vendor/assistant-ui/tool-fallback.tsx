 ...
 * Purpose: Default tool-call renderer used by assistant-ui when no per-tool UI is registered. Wraps the shared ToolCard primitive with a humanized name + arg summary in the 1-liner and pretty-printed args/result in the collapsible body.
 * Scope: Presentational only. Listens to MessagePartStatus to choose icon/tone (running/cancelled/error/complete).
 * Side-effects: none
 * Links: docs/guides/assistant-ui-tool-rendering.md, @cogni/node-ui-kit/tool-card
 * @public
 */
