...
/**
 * Module: `@cogni/wisp-doltgres-schema/tsup.config`
 * Purpose: Build configuration for @cogni/wisp-doltgres-schema — wisp's node-local Drizzle schema for the Doltgres knowledge plane.
 ...
 * Side-effects: IO
 * Links: docs/spec/packages-architecture.md, work/items/task.5077.wisp-doltgres-substrate.md
 * @internal
 */
