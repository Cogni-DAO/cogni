...
/**
 * Module: `@cogni/wisp-doltgres-schema/knowledge`
 * Purpose: wisp's Doltgres knowledge schema — pure re-export of the shared
 ...
 *   - Dialect separation: this package is NOT globbed by nodes/wisp/drizzle.config.ts
 *     (which targets Postgres); only by nodes/wisp/drizzle.doltgres.config.ts.
 * Side-effects: none
