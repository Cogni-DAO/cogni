...
// working set per dolthub/dolt#4843. Runs inside the wisp migrator
// image immediately after `drizzle-kit migrate` (see package.json
// db:migrate:wisp:doltgres:container). Tolerates only the idempotent
...
//
// Ships as part of @cogni/wisp-doltgres-schema (copied in full by the
// wisp migrator Dockerfile). Not tree-shaken by tsup because it's not
// an entry.
