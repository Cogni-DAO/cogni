...
/**
 * Module: `@cogni/lil-cog-doltgres-schema/tsup.config`
 * Purpose: Build configuration for @cogni/lil-cog-doltgres-schema — lil-cog's node-local Drizzle schema for the Doltgres knowledge plane.
 ...
 * Side-effects: IO
 * Links: docs/spec/packages-architecture.md, work/items/task.5077.lil-cog-doltgres-substrate.md
 * @internal
 */
