...
// working set per dolthub/dolt#4843. Runs inside the lil-cog migrator
// image immediately after `drizzle-kit migrate` (see package.json
// db:migrate:lil-cog:doltgres:container). Tolerates only the idempotent
...
//
// Ships as part of @cogni/lil-cog-doltgres-schema (copied in full by the
// lil-cog migrator Dockerfile). Not tree-shaken by tsup because it's not
// an entry.
