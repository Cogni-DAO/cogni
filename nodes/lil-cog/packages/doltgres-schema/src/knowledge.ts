...
/**
 * Module: `@cogni/lil-cog-doltgres-schema/knowledge`
 * Purpose: lil-cog's Doltgres knowledge schema — pure re-export of the shared
 ...
 *   - Dialect separation: this package is NOT globbed by nodes/lil-cog/drizzle.config.ts
 *     (which targets Postgres); only by nodes/lil-cog/drizzle.doltgres.config.ts.
 * Side-effects: none
