...
export default [
  ...
  {
    files: [
      "apps/operator/src/app/**/*.{ts,tsx}",
      "apps/operator/src/components/**/*.{ts,tsx}",
      "apps/operator/src/features/**/*.{ts,tsx}",
    ],
    plugins: {
  ...
  // ========================================
  {
    files: ["apps/operator/src/components/vendor/**/*.{ts,tsx}", "apps/operator/src/styles/**/*.{ts,tsx}"],
    rules: {
  ...
  {
    files: ["apps/operator/src/components/**/*.{ts,tsx}"],
    ignores: [
      "apps/operator/src/components/kit/**",
      "apps/operator/src/components/vendor/**",
      "apps/operator/src/components/index.ts",
      "apps/operator/src/components/AGENTS.md",
  ...
  {
    files: ["apps/operator/src/features/**/*.{ts,tsx}"],
    rules: {
      "no-restricted-imports": [
        "error",
        {
  ...
  {
    files: ["apps/operator/src/app/**/*.{ts,tsx}"],
    rules: {
      "no-restricted-imports": [
        "error",
        {
  ...
  {
    files: ["apps/operator/src/styles/**/*.{ts,tsx}"],
    rules: {
      "no-restricted-imports": [
        "error",
        {
  ...
  {
    files: ["apps/operator/src/components/kit/**/*.{ts,tsx}"],
    rules: {
      "no-restricted-imports": [
        "error",
        {
  ...
  {
    files: ["apps/operator/src/shared/util/cn.ts"],
    rules: {
      "no-restricted-imports": "off",
    },
  },
  ...
  {
    files: ["apps/operator/src/app/layout.tsx"],
    rules: {
      "no-restricted-imports": [
        "error",
        {
  ...
  {
    files: ["apps/operator/src/**/font*.{ts,tsx}"],
    rules: {
  ...
  {
    files: ["apps/operator/public/theme-init.js"],
    rules: {
