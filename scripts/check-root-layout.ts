...
const REQUIRED_PATHS: PathRequirement[] = [
  ...
  { anyOf: ["apps/operator/src/app"], kind: "dir" },
  { anyOf: ["apps/operator/src/features"], kind: "dir" },
  { anyOf: ["apps/operator/src/ports"], kind: "dir" },
  { anyOf: ["apps/operator/src/core"], kind: "dir" },
  { anyOf: ["apps/operator/src/adapters/server"], kind: "dir" },
  { anyOf: ["apps/operator/src/shared"], kind: "dir" },
  { anyOf: ["apps/operator/src/bootstrap"], kind: "dir" },
  { anyOf: ["apps/operator/public"], kind: "dir" },
